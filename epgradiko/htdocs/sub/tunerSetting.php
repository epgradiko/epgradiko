...
if( isset($_POST['mirakurun']) && ($_POST['mirakurun'] == 'none' || isset($_POST['mirakurun_address']) || isset($_POST['mirakurun_uds']))
	&& isset($_POST['mirakc_timeshift']) && ($_POST['mirakc_timeshift'] == 'none' || isset($_POST['mirakc_timeshift_address']))
	...
	if( $_POST['mirakc_timeshift'] === '' )	$exit_str .= 'Error:mirakc_timeshift接続設定未設定';
	if( $_POST['mirakc_timeshift'] == 'tcp' && $_POST['mirakc_timeshift_address'] === '' ) 
						$exit_str .= 'Error:TCP/IPアドレス未設定';
	...
	if( !$exit_str ){
		...
		$settings->mirakc_timeshift  = $_POST['mirakc_timeshift'];
		if( isset($_POST['mirakc_timeshift_address']) ) $settings->mirakc_timeshift_address = $_POST['mirakc_timeshift_address'];
